...
export default function Footer() {
	return (
		<div className="flex bg-zinc-900 pt-[5rem] lg:px-[5rem] xl:px-[10rem] 2xl:px-[15rem] pb-12 lg:gap-[5rem] xl:gap-[8rem] 2xl:gap-[12rem]">
			{/* Contact Numbers */}
			<div>
				{/* Contact Information */}
				<div className="xl:min-w-[20rem] 2xl:min-w-[25rem]">
					<div className="font-bold text-white xl:text-3xl 2xl:text-[3.1rem]">
						+1 123-456-789
					</div>
			...
			{/* Form */}
			<form className="flex flex-col w-full gap-4 text-white">
				<div>
					<div className="mb-3 font-bold xl:text-3xl 2xl:text-5xl">
						Contact Us
					</div>
				...
				<div>
					...
					<textarea
						className="w-full p-3 text-lg border-white rounded-md resize-y bg-zinc-800 focus:border"
